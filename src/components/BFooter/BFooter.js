...
const Footer = () => {
    return (
        <MDBFooter color="red" className="font-small pt-0">
            <MDBContainer>
                ...
                <MDBRow className="d-flex text-center justify-content-center mb-md-0 mb-4">
                    <MDBCol md="8" sm="12" className="mt-5">
                        <p style={{ lineHeight: "1.7rem" }}>
                            bottleanddrinks.com is a blog which provides information about various drinks and their
                            recipies consumed around the world.
            </p>
                    </MDBCol>
                </MDBRow>
            ...
            <div className="footer-copyright text-center py-3">
                ...
                <a href="https://www.bottleanddrinks.com" alt=""> Bottle & Drinks</a>
                </MDBContainer>
            </div>
        </MDBFooter>
    );
